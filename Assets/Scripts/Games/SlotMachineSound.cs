...
public class SlotMachineSound : MonoBehaviour
{
    ...
    {
        PlaySound(_smallWinSound);
    }

    public void PlayBigWinSound()
    {
        PlaySound(_bigWinSound);
    }

    public void PlayJackpot1Sound()
    {
        PlaySound(_jackpot1Sound);
    }

    public void PlayJackpot2Sound()
    {
        PlaySound(_jackpot2Sound);
    }

    public void PlayJackpot3Sound()
    {
        PlaySound(_jackpot3Sound);
    }
